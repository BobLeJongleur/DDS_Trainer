...
public:
	...
	bool                                               expectingDrop;                                            // 0x0490(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0491(0x0003) MISSED OFFSET
	struct FVector                                     Extent;                                                   // 0x0494(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
