...
class AdecoHangingHousePlant4_C : public AdecorativeFurniture_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass decoHangingHousePlant4.decoHangingHousePlant4_C");
		return ptr;
	}
