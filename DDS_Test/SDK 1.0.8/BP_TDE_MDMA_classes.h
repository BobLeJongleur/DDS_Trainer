...
class ABP_TDE_MDMA_C : public ATDE_MDMA
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TDE_MDMA.BP_TDE_MDMA_C");
		return ptr;
	}
	...
	void EndEffect();
	void ExecuteUbergraph_BP_TDE_MDMA(int EntryPoint);
};
