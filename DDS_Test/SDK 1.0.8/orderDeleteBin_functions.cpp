...
void UorderDeleteBin_C::ExecuteUbergraph_orderDeleteBin(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function orderDeleteBin.orderDeleteBin_C.ExecuteUbergraph_orderDeleteBin");
