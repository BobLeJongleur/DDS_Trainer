...
class AdecoModernFloorLamp2_C : public AdecoOldschoolArmchair_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass decoModernFloorLamp2.decoModernFloorLamp2_C");
		return ptr;
	}
	...
	void InputToggleOff();
	void InputToggleOn();
	void ExecuteUbergraph_decoModernFloorLamp2(int EntryPoint);
};
