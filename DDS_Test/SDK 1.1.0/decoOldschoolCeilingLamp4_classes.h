...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass decoOldschoolCeilingLamp4.decoOldschoolCeilingLamp4_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_decoOldschoolCeilingLamp4(int EntryPoint);
};
