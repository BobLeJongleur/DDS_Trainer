...
class AsmugglerShopSectorC_C : public AbaseNPC_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass smugglerShopSectorC.smugglerShopSectorC_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_smugglerShopSectorC(int EntryPoint);
};
