...
{
	static auto fn = UObject::FindObject<UFunction>("Function PM_FindWayHome.PM_FindWayHome_C.ReceiveExecute");
...
void UPM_FindWayHome_C::ExecuteUbergraph_PM_FindWayHome(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function PM_FindWayHome.PM_FindWayHome_C.ExecuteUbergraph_PM_FindWayHome");
