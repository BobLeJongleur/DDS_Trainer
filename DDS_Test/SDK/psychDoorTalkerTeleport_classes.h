...
class ApsychDoorTalkerTeleport_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass psychDoorTalkerTeleport.psychDoorTalkerTeleport_C");
		return ptr;
	}
