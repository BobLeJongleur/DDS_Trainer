...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass holyMaryLookTrigger.holyMaryLookTrigger_C");
		return ptr;
	}
	...
	void playerLookedAt();
	void ExecuteUbergraph_holyMaryLookTrigger(int EntryPoint);
};
