...
struct AUltra_Dynamic_Sky_BP_C_updateSkyWeatherConditions_Params
{
};
...
struct AUltra_Dynamic_Sky_BP_C_updateSkyLight_Params
{
};
...
struct AUltra_Dynamic_Sky_BP_C_randomCloundCap_Params
{
};
