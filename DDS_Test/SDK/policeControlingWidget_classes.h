...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass policeControlingWidget.policeControlingWidget_C");
		return ptr;
	}
	...
	void killMe();
	void ExecuteUbergraph_policeControlingWidget(int EntryPoint);
};
