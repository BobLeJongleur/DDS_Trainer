...
// BlueprintGeneratedClass SectorC_TerraceFurniture.SectorC_TerraceFurniture_C
// 0x0038 (0x0370 - 0x0338)
class ASectorC_TerraceFurniture_C : public AVillaMeshPrefab_C
{
public:
	class UStaticMeshComponent*                        StaticMeshComponent05;                                    // 0x0338(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UStaticMeshComponent*                        StaticMeshComponent04;                                    // 0x0340(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SectorC_TerraceFurniture.SectorC_TerraceFurniture_C");
		return ptr;
	}
