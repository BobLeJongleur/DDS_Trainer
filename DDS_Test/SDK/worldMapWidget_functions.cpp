...
{
	static auto fn = UObject::FindObject<UFunction>("Function worldMapWidget.worldMapWidget_C.Get_playerPosition_Visibility_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function worldMapWidget.worldMapWidget_C.Destruct");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function worldMapWidget.worldMapWidget_C.UpdateMapZoom");
