...
// BlueprintGeneratedClass GardenArrangementModule.GardenArrangementModule_C
// 0x0018 (0x04C0 - 0x04A8)
class AGardenArrangementModule_C : public AVillaModuleInstance_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GardenArrangementModule.GardenArrangementModule_C");
		return ptr;
	}
