...
public:
	...
	bool                                               openDoor;                                                 // 0x0690(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass eddieWalkAnimBP.eddieWalkAnimBP_C");
		return ptr;
	}


	void ExecuteUbergraph_eddieWalkAnimBP(int EntryPoint);
};
