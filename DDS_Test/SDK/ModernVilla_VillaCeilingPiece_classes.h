...
// BlueprintGeneratedClass ModernVilla_VillaCeilingPiece.ModernVilla_VillaCeilingPiece_C
// 0x001A (0x03EA - 0x03D0)
class AModernVilla_VillaCeilingPiece_C : public AVillaCeilingPiece_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ModernVilla_VillaCeilingPiece.ModernVilla_VillaCeilingPiece_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_ModernVilla_VillaCeilingPiece(int EntryPoint);
};
