...
// BlueprintGeneratedClass AmericanDream_SideDoubleRoof.AmericanDream_SideDoubleRoof_C
// 0x0040 (0x03B8 - 0x0378)
class AAmericanDream_SideDoubleRoof_C : public AVillaSpecialPiece_C
{
public:
	class UStaticMeshComponent*                        AmericanDream_WallTriangle_Out;                           // 0x0378(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UStaticMeshComponent*                        AmericanDream_WallTriangle_Inn;                           // 0x0380(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AmericanDream_SideDoubleRoof.AmericanDream_SideDoubleRoof_C");
		return ptr;
	}
