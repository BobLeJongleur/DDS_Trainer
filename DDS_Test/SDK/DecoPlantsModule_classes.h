...
// BlueprintGeneratedClass DecoPlantsModule.DecoPlantsModule_C
// 0x0020 (0x04C8 - 0x04A8)
class ADecoPlantsModule_C : public AVillaModuleInstance_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DecoPlantsModule.DecoPlantsModule_C");
		return ptr;
	}
