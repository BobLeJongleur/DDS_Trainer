...
class ABP_TDE_Psylocybina_C : public ATDE_Psylocybina
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TDE_Psylocybina.BP_TDE_Psylocybina_C");
		return ptr;
	}
	...
	void EndEffect();
	void ExecuteUbergraph_BP_TDE_Psylocybina(int EntryPoint);
};
