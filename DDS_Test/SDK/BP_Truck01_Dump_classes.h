...
class ABP_Truck01_Dump_C : public AActor
{
public:
	...
	class UStaticMeshComponent*                        StaticMeshComponent01;                                    // 0x0338(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Truck01_Dump.BP_Truck01_Dump_C");
		return ptr;
	}
