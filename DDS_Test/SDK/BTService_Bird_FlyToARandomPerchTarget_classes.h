...
class UBTService_Bird_FlyToARandomPerchTarget_C : public UBTService_BlueprintBase
{
public:
	...
	struct FName                                       BBKey_FlyAway_;                                           // 0x00C8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTService_Bird_FlyToARandomPerchTarget.BTService_Bird_FlyToARandomPerchTarget_C");
		return ptr;
	}


	void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds);
	void ExecuteUbergraph_BTService_Bird_FlyToARandomPerchTarget(int EntryPoint);
};
