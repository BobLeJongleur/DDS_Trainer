...
class AwarehouseBarierSegmentBP_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass warehouseBarierSegmentBP.warehouseBarierSegmentBP_C");
		return ptr;
	}
