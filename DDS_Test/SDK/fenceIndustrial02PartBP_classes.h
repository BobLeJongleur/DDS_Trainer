...
class AfenceIndustrial02PartBP_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass fenceIndustrial02PartBP.fenceIndustrial02PartBP_C");
		return ptr;
	}
