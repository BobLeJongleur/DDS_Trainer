...
class AdecoHangingHousePlant3_C : public AdecorativeFurniture_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass decoHangingHousePlant3.decoHangingHousePlant3_C");
		return ptr;
	}
