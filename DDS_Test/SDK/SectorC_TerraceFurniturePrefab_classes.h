...
// BlueprintGeneratedClass SectorC_TerraceFurniturePrefab.SectorC_TerraceFurniturePrefab_C
// 0x0038 (0x0370 - 0x0338)
class ASectorC_TerraceFurniturePrefab_C : public AVillaMeshPrefab_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SectorC_TerraceFurniturePrefab.SectorC_TerraceFurniturePrefab_C");
		return ptr;
	}
