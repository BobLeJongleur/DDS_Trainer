...
class ABP_AS_Metaamfetamina_C : public AAS_Metaamfetamina
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_AS_Metaamfetamina.BP_AS_Metaamfetamina_C");
		return ptr;
	}
