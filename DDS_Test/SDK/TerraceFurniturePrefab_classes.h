...
// BlueprintGeneratedClass TerraceFurniturePrefab.TerraceFurniturePrefab_C
// 0x0038 (0x0370 - 0x0338)
class ATerraceFurniturePrefab_C : public AVillaMeshPrefab_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TerraceFurniturePrefab.TerraceFurniturePrefab_C");
		return ptr;
	}
