...
class AdecoHangingHousePlant7_C : public AdecorativeFurniture_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass decoHangingHousePlant7.decoHangingHousePlant7_C");
		return ptr;
	}
