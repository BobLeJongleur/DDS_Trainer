...
class UbankHintCloudWidget_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass bankHintCloudWidget.bankHintCloudWidget_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_bankHintCloudWidget(int EntryPoint);
};
