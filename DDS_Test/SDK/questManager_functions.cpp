...
{
	static auto fn = UObject::FindObject<UFunction>("Function questManager.questManager_C.eddieCallPsychedelics");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function questManager.questManager_C.eddieRepeatPsychedelics");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function questManager.questManager_C.retryEddiePsychedelics");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function questManager.questManager_C.eddieCallPsychedelicsEnd");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function questManager.questManager_C.eddieRepeatPsychedelicsEnd");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function questManager.questManager_C.retryEddiePsychedelicsEnd");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function questManager.questManager_C.eddieEndPsychedelics");
