...
public:
	...
	inline void ProcessEvent(class UFunction* function, void* parms) {
		auto vFunction = GetVFunction<void(*)(UObject*, class UFunction*, void*)>(this, 64);
		return vFunction(this, function, parms);
	}


	void ExecuteUbergraph(int EntryPoint);

	inline UObject* GetOuter() const
	{
		return Outer;
	}
};
...
public:
	...
	unsigned char                                      UnknownData0x0048[0x30];                                  // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
...
public:
	...
	uint64_t PropertyFlags;				// 8
	uint16_t RepIndex;					// 2
	int32_t Offset_Internal;			// 4
	unsigned char UnknownData00[0x2A];
