...
{
	static auto fn = UObject::FindObject<UFunction>("Function BTService_Bird_Shuffle_SkyTarget_WhenNearCurrent.BTService_Bird_Shuffle_SkyTarget_WhenNearCurrent_C.ReceiveTickAI");
...
void UBTService_Bird_Shuffle_SkyTarget_WhenNearCurrent_C::ExecuteUbergraph_BTService_Bird_Shuffle_SkyTarget_WhenNearCurrent(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function BTService_Bird_Shuffle_SkyTarget_WhenNearCurrent.BTService_Bird_Shuffle_SkyTarget_WhenNearCurrent_C.ExecuteUbergraph_BTService_Bird_Shuffle_SkyTarget_WhenNearCurrent");
