...
// BlueprintGeneratedClass GardenLightsModule.GardenLightsModule_C
// 0x0020 (0x04C8 - 0x04A8)
class AGardenLightsModule_C : public AVillaModuleInstance_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GardenLightsModule.GardenLightsModule_C");
		return ptr;
	}
