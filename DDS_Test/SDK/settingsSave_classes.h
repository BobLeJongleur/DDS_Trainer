...
public:
	...
	float                                              mouseSenseNew;                                            // 0x00F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	bool                                               audioEnableBinaural;                                      // 0x0109(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
