...
class UpoliceSearchWidget_C : public UUserWidget
{
public:
	...
	void Construct();
	void RemoveMe();
	void ExecuteUbergraph_policeSearchWidget(int EntryPoint);
};
