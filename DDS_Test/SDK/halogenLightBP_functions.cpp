...
{
	static auto fn = UObject::FindObject<UFunction>("Function halogenLightBP.halogenLightBP_C.ToggleShadows");
...
void AhalogenLightBP_C::BndEvt__RamaSave_K2Node_ComponentBoundEvent_0_RamaSaveFullyLoadedSignature__DelegateSignature(class URamaSaveComponent* RamaSaveComponent, const struct FString& LevelPackageName)
{
	static auto fn = UObject::FindObject<UFunction>("Function halogenLightBP.halogenLightBP_C.BndEvt__RamaSave_K2Node_ComponentBoundEvent_0_RamaSaveFullyLoadedSignature__DelegateSignature");
