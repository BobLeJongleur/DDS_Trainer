...
public:
	...
	struct FappartmentEquipment                        Data;                                                     // 0x0238(0x0050) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	class UAppManageList_C*                            SourceList;                                               // 0x0290(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	int                                                Quantity;                                                 // 0x0298(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass AppManageListItem.AppManageListItem_C");
		return ptr;
	}
