...
// BlueprintGeneratedClass SectorC_DecorativePlantsPrefab.SectorC_DecorativePlantsPrefab_C
// 0x0030 (0x0368 - 0x0338)
class ASectorC_DecorativePlantsPrefab_C : public AVillaMeshPrefab_C
{
public:
	...
	class UStaticMeshComponent*                        StaticMeshComponent03;                                    // 0x0340(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	class USceneComponent*                             SharedRoot;                                               // 0x0360(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SectorC_DecorativePlantsPrefab.SectorC_DecorativePlantsPrefab_C");
		return ptr;
	}
