...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass sewageTeleportWidget.sewageTeleportWidget_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_sewageTeleportWidget(int EntryPoint);
};
