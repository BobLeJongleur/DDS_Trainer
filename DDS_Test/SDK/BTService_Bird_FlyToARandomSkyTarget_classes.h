...
class UBTService_Bird_FlyToARandomSkyTarget_C : public UBTService_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTService_Bird_FlyToARandomSkyTarget.BTService_Bird_FlyToARandomSkyTarget_C");
		return ptr;
	}
