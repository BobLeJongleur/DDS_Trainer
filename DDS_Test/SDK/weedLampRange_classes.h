...
class AweedLampRange_C : public AActor
{
public:
	...
	float                                              MaxRange;                                                 // 0x0350(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass weedLampRange.weedLampRange_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_weedLampRange(int EntryPoint);
};
