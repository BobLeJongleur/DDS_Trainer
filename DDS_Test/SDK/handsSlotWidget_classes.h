...
// WidgetBlueprintGeneratedClass handsSlotWidget.handsSlotWidget_C
// 0x0018 (0x0220 - 0x0208)
class UhandsSlotWidget_C : public UUserWidget
{
public:
	...
	void ExecuteUbergraph_handsSlotWidget(int EntryPoint);
};
