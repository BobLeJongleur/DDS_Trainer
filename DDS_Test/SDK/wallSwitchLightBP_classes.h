...
public:
	...
	class USphereComponent*                            pawnOverlap;                                              // 0x0428(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AappartmentLight_C*                          lightRef;                                                 // 0x0430(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	bool                                               Double;                                                   // 0x0438(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0439(0x0007) MISSED OFFSET
	struct FText                                       textActionTurnOn;                                         // 0x0440(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       textActionTurnOff;                                        // 0x0458(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	float                                              widgetDrawDistance;                                       // 0x0470(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	TArray<class AActor*>                              overlaps;                                                 // 0x0480(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance)
